...
public class FadeObjectInOut : MonoBehaviour
{
    ...
    IEnumerator FadeSequence(float fadingOutTime)
    {
        ...
        AppManager._areObjectFaded = true;
    ...
    void Update()
    {
        if (AppManager._toFadeIn == true)
        {
            Debug.Log("fade In == true");
            FadeIn();
            AppManager._toFadeIn = false;
        }
        if (AppManager._toFadeOut == true)
        {
            Debug.Log("fade Out == true");
            FadeOut();
            AppManager._toFadeOut = false;
        }
    }
}